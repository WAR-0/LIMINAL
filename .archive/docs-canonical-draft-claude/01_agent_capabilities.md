...
The AI Director Agent has unique capabilities for orchestrating the team, including handling escalations and monitoring system health.
...
<!-- [[EDITOR_NOTE_CODEX: Please review for conciseness while maintaining technical completeness.]] -->
...
| Complex discussion | Spawn clone | Coordinate | Clone discussion |
...
1. **Minimize Context Size**: Keep snapshots under 4KB when possible
